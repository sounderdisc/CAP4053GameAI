...
public class CirclerPilot : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        angleToShoot = 3.0f; ignoreDamping = true; haltDebug = false; maneuverAgressiveness = 1.0f; baseThrust = 5.0f; baseRotation = 100.0f; maxSpeed = 20.0f; idealSpeed = 15.0f;
